...
site/
  ...
  assets/
    knowledge-base.js       ← site assistant answers (edit anytime)
    site-assistant.js       ← chat widget code (rarely needs editing)
  modules/
...
**To add or correct an answer**: open `assets/knowledge-base.js` and edit
the relevant entry (or add a new `{q, a, keywords}` object). Changes apply
across every page immediately — no other file needs touching.
