...
## Design
The hub, FAQ, and cheat sheet pages use Healthia's navy blue as the primary
brand color, with Sora (headings) and Inter (body text) loaded from Google
Fonts. This needs an internet connection to load properly — if a clinic's
network blocks Google Fonts, the pages will still work fine, just fall back
to the system default font instead of Sora/Inter.
...
site/
  ...
  faq.html
  cheatsheet.html
  templates.html          ← ready-to-copy email templates (Reminder/Further Reminder/Final Notice)
